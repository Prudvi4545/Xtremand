...
# ✅ MinIO settings
# MINIO_ENDPOINT = "localhost:9000"  # or your MinIO server URL + port
# MINIO_ACCESS_KEY = "minioadmin"    # or your real access key
# MINIO_SECRET_KEY = "minioadmin"    # or your real secret key
# MINIO_BUCKET_NAME = "my-data-lake"  # or your desired bucket name